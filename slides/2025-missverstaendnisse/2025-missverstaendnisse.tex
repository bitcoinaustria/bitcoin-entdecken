...
\misconceptionslide[pix/bitcoin-skalieren.jpg]{Skalierbarkeit}{Bitcoin kann nur 3-4 Transaktionen pro Sekunde verarbeiten}{%
        ...
        \item \textbf{Lightning Network}: bis zu \textbf{1 Million TPS} möglich
        \item Visa: \textbf{65.000 TPS}, \textbf{150 Mio. Transaktionen/Tag}\footnotemark
        \item Bitcoin Transaktionsvolumen: \textbf{20 Bio. \$} vs. Visa \textbf{13 Bio. \$}\footnotemark
	\only<2->{\footnotetext[1]{Visa Inc. Annual Report 2023}}
	\only<2->{\footnotetext[2]{Sygnum Bank Report, 2024}}
        \item Lightning theoretisch \textbf{15x schneller} als Visa - global, ohne Intermediäre
        \item Haken: VISA ist kein \textbf{finales Settlement} wie Bitcoin
...
\misconceptionslide[pix/kriminalitaet.jpg]{Kriminalität}{Bitcoin wird hauptsächlich für illegale Aktivitäten verwendet}{%
        \item Anteil illegaler Bitcoin-Transaktionen nur noch \textbf{0,34\%}\footnotemark
...
\only<2->{\footnotetext[2]{United Nations Schätzung}}
        ...
        \item \textbf{Europol} betrachtet vor allem Bargeld und das traditionelle Bankensystem als relevant für Geldwäsche
